...
# Your CODE HERE
		...
		addi $t5,$0,4			#Element Size(4byte=1word)
       ...
       loop0:   bge  $t2,$s1,loop1
                ...
                addi $t2,$t2,1	      #increment counter for k
                b loop0
                
       loop1:   addi $t1,$t1,1       #increment counter for j
                b loop4
                
       loop2:   addi $t0,$t0,1	    #increment counter for i
                b loop5
